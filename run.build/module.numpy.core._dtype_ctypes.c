...
static PyObject *impl_numpy$core$_dtype_ctypes$$$function__1__from_ctypes_array(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_e3d10e634016110a6f17ad916a17b99b = MAKE_FUNCTION_FRAME(codeobj_e3d10e634016110a6f17ad916a17b99b, module_numpy$core$_dtype_ctypes, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_e3d10e634016110a6f17ad916a17b99b);
...
static PyObject *impl_numpy$core$_dtype_ctypes$$$function__2__from_ctypes_structure(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_15534cea0e07f510edced597c2f943f5)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_15534cea0e07f510edced597c2f943f5 = MAKE_FUNCTION_FRAME(codeobj_15534cea0e07f510edced597c2f943f5, module_numpy$core$_dtype_ctypes, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_15534cea0e07f510edced597c2f943f5);
...
static PyObject *impl_numpy$core$_dtype_ctypes$$$function__3__from_ctypes_scalar(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_5cda1fc1ac451a02ad97e6d8e1173fa1)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_5cda1fc1ac451a02ad97e6d8e1173fa1 = MAKE_FUNCTION_FRAME(codeobj_5cda1fc1ac451a02ad97e6d8e1173fa1, module_numpy$core$_dtype_ctypes, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_5cda1fc1ac451a02ad97e6d8e1173fa1);
...
static PyObject *impl_numpy$core$_dtype_ctypes$$$function__4__from_ctypes_union(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_c43265faf376006149932d8f7ab8e4f9)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_c43265faf376006149932d8f7ab8e4f9 = MAKE_FUNCTION_FRAME(codeobj_c43265faf376006149932d8f7ab8e4f9, module_numpy$core$_dtype_ctypes, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_c43265faf376006149932d8f7ab8e4f9);
...
static PyObject *impl_numpy$core$_dtype_ctypes$$$function__5_dtype_from_ctypes_type(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_30fdf4ae09b105f6304aeb30b5006a82)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_30fdf4ae09b105f6304aeb30b5006a82 = MAKE_FUNCTION_FRAME(codeobj_30fdf4ae09b105f6304aeb30b5006a82, module_numpy$core$_dtype_ctypes, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_30fdf4ae09b105f6304aeb30b5006a82);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_7b872cb38c30d73ed675845d6cc8ba34);
