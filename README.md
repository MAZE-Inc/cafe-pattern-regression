...
<img src="./images/카페 A 좌석 점유율 예측 그래프.png" width="700">
<img src="./images/카페 A 좌석 점유율 예측 그래프2.png" width="700">

## 고객층 예측 모델
- 아래 그림은 자사의 고객층 예측 모델로 요일별, 시간별 예측을 시각화한 그림입니다.
<img src="./images/카페 A 남성 비율 예측 그래프.png" width="700">
<img src="./images/카페 A 남성 비율 예측 그래프2.png" width="700">

## 행동 패턴 예측 모델
- 아래 그림은 자사의 행동 패턴 예측 모델로 요일별, 시간별 예측을 시각화한 그림입니다.
<img src="./images/카페 A 행동 예측 그래프.png" width="700">
<img src="./images/카페 A 행동 예측 그래프2.png" width="700">

## 메뉴 예측 모델
- 아래 그림은 자사의 메뉴 예측 모델로 요일별, 시간별 예측을 시각화한 그림입니다.
<img src="./images/카페 A 메뉴 추론 그래프.jpg" width="700">
<img src="./images/카페 A 메뉴 추론 그래프2.jpg" width="700">
